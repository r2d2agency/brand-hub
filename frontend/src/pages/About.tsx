  ...
  return (
    <div className="bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-24">
        <h2 className="text-center text-2xl md:text-3xl font-black text-blue-900 mb-12">Nossas Unidades</h2>
        <div className="grid gap-6 md:grid-gap-8 md:grid-cols-2">
          {stores.map((store: any) => (
            <div key={store.id} className="rounded-3xl bg-white p-6 md:p-8 shadow-sm border border-slate-100 flex flex-col md:flex-row gap-6">
              <div className="h-32 md:h-40 w-full md:w-40 rounded-2xl bg-blue-50 shrink-0 flex items-center justify-center text-blue-900/20">
                <MapPin size={40} />
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-black text-blue-900 mb-3 md:mb-4">{store.name}</h3>
                ...
                <a 
                  ...
                  className="mt-6 inline-flex items-center gap-2 text-xs md:text-sm font-bold text-red-600 hover:text-red-700"
                >

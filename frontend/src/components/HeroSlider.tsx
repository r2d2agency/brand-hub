...
export default function HeroSlider() {
  ...
  if (isLoading) {
    return (
      <div className="h-[350px] md:h-[500px] lg:h-[650px] w-full bg-blue-900 animate-pulse flex items-center justify-center">
  ...
  if (banners.length === 0) {
    return (
      <section className="relative h-[350px] md:h-[500px] lg:h-[650px] overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 flex items-center">
  ...
  return (
    <section className="relative h-[350px] md:h-[500px] lg:h-[700px] w-full bg-slate-900 overflow-hidden">
      <Swiper
